...
<body>
	<div class="container">
		<h1>Classroom Flow</h1>
		<p>Inserimento allievi</p>
		<form:form action="${ flowExecutionUrl }" method="post"
			...
			<form:button type="submit" class="btn btn-primary" name="_eventId_add">Aggiungi</form:button>
		</form:form>
	</div>
